#!/usr/bin/env python3
"""
nerdymark's Game.com Downloader for ES-DE
...
class DownloaderUI:
    def __init__(self):
        ...
        pygame.display.set_caption("nerdymark's Game.com Downloader")
    ...
    def get_existing_games(self):
        ...
        if rom_path.exists():
            for f in rom_path.iterdir():
                if f.suffix.lower() in ['.zip', '.bin', '.tgc']:
                    existing.add(f.stem)
        return existing
    ...
    def draw_main_menu(self):
        ...
        draw_title_with_glow(self.screen, self.font_large, "NERDYMARK'S GAME.COM DOWNLOADER", ACCENT, 20)
