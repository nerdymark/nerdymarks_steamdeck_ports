#!/usr/bin/env python3
"""
nerdymark's Atari Jaguar Downloader for ES-DE
...
class DownloaderUI:
    def __init__(self):
        ...
        pygame.display.set_caption("nerdymark's Atari Jaguar Downloader")
    ...
    def get_existing_games(self):
        ...
        if rom_path.exists():
            for f in rom_path.iterdir():
                if f.suffix.lower() in ['.zip', ''.j64', '.jag', '.rom']:
                    existing.add(f.stem)
        return existing
    ...
    def draw_main_menu(self):
        ...
        draw_title_with_glow(self.screen, self.font_large, "NERDYMARK'S ATARI JAGUAR DOWNLOADER", ACCENT, 20)
