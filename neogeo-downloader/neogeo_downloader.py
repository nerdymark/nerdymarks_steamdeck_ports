...
Downloads games from Myrient's Redump Neo Geo CD collection
...
BASE_URL = "https://myrient.erista.me/files/Redump/SNK%20-%20Neo%20Geo%20CD/"
NEOGEO_ROM_DIR = "/run/media/deck/SK256/Emulation/roms/neogeocd"
...
# Colors - Gloomy Blue theme
THEME = get_theme('neogeo')
ACCENT = THEME['accent']
...
class NeoGeoDownloaderUI:
    def __init__(self):
        ...
        pygame.display.set_caption("nerdymark's Neo Geo CD Downloader")
    ...
    def get_disk_space(self):
        ...
        try:
            stat = os.statvfs(NEOGEO_ROM_DIR)
    ...
    def draw_main_menu(self):
        ...
        # Header with glow
        draw_title_with_glow(self.screen, self.font_large, "NERDYMARK'S NEO GEO CD DOWNLOADER", ACCENT, 20)
    ...
    def download_game(self, game_name, href):
        """Download a Neo Geo CD game - just save the ZIP directly"""
        ...
        dest_path = os.path.join(NEOGEO_ROM_DIR, filename)
    ...
    def run(self):
        os.makedirs(NEOGEO_ROM_DIR, exist_ok=True)
