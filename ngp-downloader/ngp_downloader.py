#!/usr/bin/env python3
"""
nerdymark's Neo Geo Pocket Downloader for ES-DE
...
class DownloaderUI:
    def __init__(self):
        ...
        pygame.display.set_caption("nerdymark's Neo Geo Pocket Downloader")
    ...
    def draw_main_menu(self):
        ...
        draw_title_with_glow(self.screen, self.font_large, "NERDYMARK'S NEO GEO POCKET DOWNLOADER", ACCENT, 20)
