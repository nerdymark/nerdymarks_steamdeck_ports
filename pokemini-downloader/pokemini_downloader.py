#!/usr/bin/env python3
"""
nerdymark's Pokemon Mini Downloader for ES-DE
...
BASE_URL = "https://myrient.erista.me/files/No-Intro/Nintendo%20-%20Pokemon%20Mini/"
ROM_DIR = "/run/media/deck/SK256/Emulation/roms/pokemini"

THEME = get_theme('pokemini')
ACCENT = THEME['accent']
...
class DownloaderUI:
    def __init__(self):
        ...
        pygame.display.set_caption("nerdymark's Pokemon Mini Downloader")
    ...
    def draw_main_menu(self):
        ...
        draw_title_with_glow(self.screen, self.font_large, "NERDYMARK'S POKEMON MINI DOWNLOADER", ACCENT, 20)
