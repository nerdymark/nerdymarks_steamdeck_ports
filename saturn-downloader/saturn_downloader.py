...
Downloads games from Myrient's Redump Sega Saturn collection
...
# Colors - Saturn Teal theme
THEME = get_theme('saturn')
ACCENT = THEME['accent']
...
class SaturnDownloaderUI:
    def __init__(self):
        ...
        pygame.display.set_caption("nerdymark's Saturn Downloader")
    ...
    def fetch_game_list(self):
        self.draw_message("Connecting to Myrient...", "Fetching Saturn game list, please wait")
        pygame.display.flip()
    ...
    def get_disk_space(self):
        try:
            stat = os.statvfs(SATURN_ROM_DIR)
    ...
    def draw_main_menu(self):
        ...
        draw_title_with_glow(self.screen, self.font_large, "NERDYMARK'S SATURN DOWNLOADER", ACCENT, 20)
    ...
    def download_game(self, game_name, href):
        ...
        dest_path = os.path.join(SATURN_ROM_DIR, filename)
