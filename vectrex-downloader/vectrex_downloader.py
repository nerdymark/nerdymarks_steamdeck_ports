#!/usr/bin/env python3
"""
nerdymark's Vectrex Downloader for ES-DE
...
BASE_URL = "https://myrient.erista.me/files/No-Intro/GCE%20-%20Vectrex/"
ROM_DIR = "/run/media/deck/SK256/Emulation/roms/vectrex"

THEME = get_theme('vectrex')
ACCENT = THEME['accent']
...
class DownloaderUI:
    def __init__(self):
        ...
        pygame.display.set_caption("nerdymark's Vectrex Downloader")
    ...
    def get_existing_games(self):
        ...
        if rom_path.exists():
            for f in rom_path.iterdir():
                if f.suffix.lower() in ['.zip', '.vec', '.bin']:
                    existing.add(f.stem)
        return existing
    ...
    def draw_main_menu(self):
        ...
        draw_title_with_glow(self.screen, self.font_large, "NERDYMARK'S VECTREX DOWNLOADER", ACCENT, 20)
